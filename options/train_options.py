...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--display_env', type=str, default='my_env', help='visdom display environment name (default is "main")')
        ...
        parser.add_argument('--lr_D', type=float, default=0.00002, help='initial learning rate for adam')
        ...
        parser.add_argument('--n_scales_temporal', type=int, default=2, help='number of temporal scales in the temporal discriminator')        
        parser.add_argument('--max_frames_backpropagate', type=int, default=1, help='max number of frames to backpropagate') 
        ...
        parser.add_argument('--niter_step', type=int, default=5, help='how many epochs do we change training batch size again')
        parser.add_argument('--niter_fix_global', type=int, default=0, help='if specified, only train the finest spatial layer for the given iterations')
